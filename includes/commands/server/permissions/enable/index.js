...
module.exports = (async function(client, helpers) {
    ...
    exports.meta.aliases = [`permit`, `allow`];
    exports.meta.description = `Enable a permission.\n`
    ...
    exports.run = async (client, message, arg) => {
        ...
        let embed = await dbGuild.updatePermissions(message.member, arg, true, `Enabled`);
